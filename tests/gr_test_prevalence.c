...
int main() {
	...
	*/
	...
	gr_compute_local_prevalence(testGr, 1, 1, prevalence,0);
	...
	gr_compute_local_prevalence(testGr, 2, 2, prevalence,0);
	...
	gr_compute_local_prevalence(testGr, 0, 1, prevalence,0);
